...
public class Cliente implements Serializable {
    ...
    public Cliente(Integer id, String nombre, String apellido, Integer edad, String direccion, String email, String telefono, String tipoDocumento, String numeroDocumento) {
        this.id = id;
        this.nombre = nombre;
        this.apellido = apellido;
        this.edad = edad;
    ...
    public Cliente(String nombre, String apellido, Integer edad, String direccion, String email, String telefono, String tipoDocumento, String numeroDocumento) {
        this.nombre = nombre;
        this.apellido = apellido;
        this.edad = edad;
        this.direccion = direccion;
